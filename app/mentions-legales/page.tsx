  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-16 bg-slate-50 min-h-screen">
        <h1 className="text-4xl font-bold mb-8 text-center text-slate-800">Mentions Légales</h1>

        <div className="max-w-4xl mx-auto space-y-8">
          <section className="bg-white rounded-lg p-6 shadow-sm">
            <h2 className="text-2xl font-bold mb-4 text-blue-600">Éditeur du Site</h2>
            <div className="text-slate-700 space-y-2">
              <p>
                <strong>Nom du site :</strong> ParisSportifsFrance.com
              </p>
              <p>
          ...
          <section className="bg-white rounded-lg p-6 shadow-sm">
            <h2 className="text-2xl font-bold mb-4 text-blue-600">Hébergement</h2>
            <div className="text-slate-700 space-y-2">
              <p>
          ...
          <section className="bg-white rounded-lg p-6 shadow-sm">
            <h2 className="text-2xl font-bold mb-4 text-blue-600">Jeu Responsable</h2>
          ...
          <section className="bg-white rounded-lg p-6 shadow-sm">
            <h2 className="text-2xl font-bold mb-4 text-blue-600">Droit Applicable</h2>
            <p className="text-slate-700 leading-relaxed">
